...
public class GlobalExceptionMiddlewareTests
{
    ...
    public async Task InvokeAsync_AppException_ReturnsStatusAndMessage()
    {
        ...
        var middleware = new GlobalExceptionMiddleware(
            _ => throw new ConflictAppException("Profile already exists"),
            logger.Object);
        ...
        Assert.That(json.GetProperty("message").GetString(), Is.EqualTo("Profile already exists"));
    ...
    public async Task InvokeAsync_UnhandledException_Returns500WithGenericMessage()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo("An unexpected error occurred. Please try again later."));
